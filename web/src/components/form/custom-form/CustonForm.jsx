...
import { Icon, Inputs, FormSettings } from '@/components';
import { httpAddOrUpdateSettingsForm } from '@/services';
import { CampaignContext } from '@/context';

export default function CustonForm({ settingForm, onClose }) {
    ...
    return (
        <>
            <Form layout='vertical' autoCapitalize='on' autoComplete='off' onFinish={handleSubmit}>
            ...
            <Modal open={modal} onCancel={() => setModal(false)} centered width={700} footer={null} title={<h4>Configuración</h4>}>
                <FormSettings
                    onClose={input => {
